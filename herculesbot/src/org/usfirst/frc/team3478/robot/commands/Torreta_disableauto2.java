...
public class Torreta_disableauto2 extends Command{
	
	Command main_torreta;
	
	public Torreta_disableauto2() {
		// Use requires() here to declare subsystem dependencies
		requires(Robot.torreta);
		main_torreta = new Torreta_main();
	}
	...
	protected void execute() {
		Robot.torreta.Diactivate_auto2();
	}

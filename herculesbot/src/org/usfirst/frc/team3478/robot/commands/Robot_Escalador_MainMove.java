 ...
 */
public class Robot_Escalador_MainMove extends Command {
	public Robot_Escalador_MainMove() {
	...
	protected void execute() {
		Robot.Robot_escalador.Main_Escalador();
	}
	...
	@Override
	protected void end() {
		Robot.Robot_escalador.Stop_Escalador();
	}

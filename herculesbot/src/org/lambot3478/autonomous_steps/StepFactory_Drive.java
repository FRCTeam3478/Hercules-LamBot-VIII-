...
public class StepFactory_Drive {
	...
	public static AutonomousStep_Drive getNewFwdDistance(double power,double distance){
		return new ForwardDistance(power,distance);
	}
	public static AutonomousStep_Drive getNewFwdDistance(){
		return new WaitForBox();
	}
